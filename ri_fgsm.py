# coding=utf-8
"""Implementation of RI-FGSM (RMSProp for I-FGSM) attack."""
...
tf.flags.DEFINE_float('gamma',0.9,'decay factor of the accumulated squares of gradients?')
...
def graph(x, y, i, x_max, x_min, accum_grad):
    ...
    accum_grad = grad * grad * (1-gamma) + accum_grad * gamma

    x = x + alpha * tf.sign(grad_normed)
