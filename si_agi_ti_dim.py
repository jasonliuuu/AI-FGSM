# coding=utf-8
"""Implementation of SI-RI-FGSM (Scale-Invariant AdaGrad Iterative Fast Gradient Sign Method)."""
...
def graph(x, y, i, x_max, x_min, accum_grad):
    ...
    x = x + tf.divide(alpha,tf.sqrt(accum_grad + 1e-8)) * tf.sign(grad_normed)
